...
export default function Registrar_Items_Aceite_Motor(context) {
    try {
        ...
        let orden = context.evaluateTargetPath('#Page:Registrar_Aceite_Motor/#Control:orden_motor/#Value');
        ...
        // Validar operario
        return context.read('/appconsumos_mb/Services/app_consumos_prd.service', 'Empleados', [], `$filter=ficha eq '${operario_motor}'`)
            .then((results) => {
