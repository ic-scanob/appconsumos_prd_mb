...
export default function Registrar_Items_Aceite_Hidraulico(context) {
    try {
        ...
        let orden = context.evaluateTargetPath('#Page:Registrar_Aceite_Hidraulico/#Control:orden_hidraulico/#Value');
        ...
        // Validar operario
        return context.read('/appconsumos_mb/Services/app_consumos_prd.service', 'Empleados', [], `$filter=ficha eq '${operario_hidraulico}'`)
            .then((results) => {
