 ...
 */
export default function Rechazar_Planilla_Aceite_Diferencial(context) {
    ...
    return context.executeAction({
        ...
        "Properties": {
            ...
            "OKCaption": "Aceptar",
            "OnOK": "/appconsumos_mb/Actions/oData/Update_Planilla_Aceite_Rechazar_Diferencial.action",
