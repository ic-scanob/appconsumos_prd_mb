 ...
 */
export default async function onChange_RevisarPlanillaConsumo(context) {
    ...
    let clientDataDetalle = context.evaluateTargetPathForAPI('#Page:Detalle_Aceite_Motor').getClientData();
